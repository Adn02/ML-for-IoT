...
for name in list_of_names:
    people[name] = person(name=name, age=list_of_ages[i], height=list_of_heights_cm[i])
    i = i + 1
...
def classify_iris(features):
    weights = np.array([[0.72290817, -0.50526792, -0.83632461,  0.15940539],
                        [0.47654054, -0.91161626,  0.4933197,  -0.74196594],
                        [0.97933693, -2.51135122,  0.39607604,  0.59762687]])
